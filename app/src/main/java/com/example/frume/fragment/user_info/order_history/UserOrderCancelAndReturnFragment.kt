package com.example.frume.fragment.user_info.order_history
...
import com.example.frume.databinding.FragmentUserOrderCancelAndReturnBinding

class UserOrderCancelAndReturnFragment() : Fragment() {
    private var _binding: FragmentUserOrderCancelAndReturnBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = DataBindingUtil.inflate(inflater, R.layout.fragment_user_order_cancel_and_return, container, false)
